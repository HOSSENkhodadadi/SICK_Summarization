...
parser.add_argument('--model_name', type=str, default=model_checkpoint)
...
parser.add_argument('--encoder_max_len', type=int, default=max_len)
parser.add_argument('--decoder_max_len', type=int, default=100)
parser.add_argument('--vocab_size', type=int, default=vocab_size)
parser.add_argument('--eos_idx', type=int, default=50256)
parser.add_argument('--tokenizer_name', type=str, default=tokenizer_checkpoint)

# Checkpoint directory hyperparameters
parser.add_argument('--pretrained_weight_path', type=str, default='pretrained_weights')
parser.add_argument('--finetune_weight_path', type=str, default="./context_GPT2_weights_Samsum_5epoch")
parser.add_argument('--best_finetune_weight_path', type=str, default='context_final_GPT2_weights_Samsum_5epoch')
